...
async function main() {
  ...
  const products = [
    ...
    { name: 'Haribo Goldb?ren 175g', description: 'Klassische Goldb?ren Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 100, featured: true },
    { name: 'Haribo Happy Cola 175g', description: 'Cola-Flaschen Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Haribo Phantasia 175g', description: 'Bunte Fruchtgummi-Mischung.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 75, featured: false },
    { name: 'Haribo Pfirsiche 175g', description: 'Pfirsich-Fruchtgummi mit Zucker.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Haribo Lakritz Schnecken', description: 'Lakritz-Schnecken.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Haribo Rainbow Sauer 175g', description: 'Saure Regenbogen-Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Nimm2 Lachgummi Softies Frucht Mix 225g', description: 'Weiche Fruchtgummis mit Vitaminen.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Bubble Fizz 1kg', description: 'Brause-Fruchtgummi im Gro?pack.', priceNet: 23.32, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 15, featured: false },
    { name: 'Haribo Balla-Balla 175g', description: 'Schaumzucker-Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 65, featured: false },
    { name: 'Haribo Bunte T?te 175g', description: 'Bunte Fruchtgummi-Mischung.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 80, featured: true },
    { name: 'Haribo Konfekt 175g', description: 'Feine Fruchtgummi-Konfekt Mischung.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 55, featured: false },
    { name: 'Bunte T?te', description: 'Selbstgemachte S??igkeitent?te.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 100, featured: false },
    { name: 'Haribo Tropi Frutti 175g', description: 'Exotische Fruchtgummi-Mischung.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Haribo Wein Gums 175g', description: 'Weinbrandbohnen-Art Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Se Snacks', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 55, featured: false },
