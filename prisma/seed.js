...
async function main() {
  console.log('=== YaNa Kiosk Barsbüttel - Database Seeding ===\n');
  ...
  const catNames = [
    ...
    'Kaugummi','Kinderartikel','Getränkekisten','Lebensmittel','Rauchbedarf','Drogerie'
  ];
  ...
  const products = [
    // Schokoladenriegel (7% VAT)
    { name: 'Snickers 50g', description: 'Schokoladenriegel mit Erdnuss und Karamell.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 100, featured: true },
    { name: 'Twix 50g', description: 'Knuspriger Keksriegel mit Karamell.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 100, featured: true },
    { name: 'Milky Way 43g', description: 'Luftiger Milchschokoladenriegel.', priceNet: 2.76, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Ferrero Kinder Bueno 43g', description: 'Zarter Haselnussriegel.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 90, featured: true },
    { name: 'Ferrero Kinder Bueno White 43g', description: 'Wei?er Haselnussriegel.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 75, featured: false },
    { name: 'Mars 51g', description: 'Schokoladenriegel mit Karamell-Nougat.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 100, featured: true },
    { name: 'Bounty 57g', description: 'Kokosriegel mit Milchschokolade.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Daim 28g', description: 'Mandel-Krokant-Riegel.', priceNet: 2.34, vatRate: 7, category: 'Schokoladenriegel', image: 'https://images.unsplash.com/photo-1627308595220-5a1f14c2b8c6?w=400&h=400&fit=crop', stock: 85, featured: false },
    // Sweets & Snacks (7% VAT - food)
    { name: 'Nutella Biscuits 304g', description: 'Knusprige Kekse mit Nutella Creme.', priceNet: 6.50, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 40, featured: false },
    { name: 'Pipapo Naturell 100g', description: 'Sonnenblumenkerne naturbelassen.', priceNet: 3.74, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 50, featured: false },
    { name: 'Pipapo Salz 100g', description: 'Sonnenblumenkerne gesalzen.', priceNet: 3.74, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 50, featured: false },
    { name: 'Pipapo Sweet Popcorn 100g', description: 'Sonnenblumenkerne mit Popcorn Geschmack.', priceNet: 3.74, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 40, featured: false },
    { name: 'Ricola Kr?uter Original 75g', description: 'Kr?uterbonbons aus Schweizer Alpenkr?utern.', priceNet: 3.74, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Nic Nac\'s 110g', description: 'Erdn?sse im knusprigen Teigmantel.', priceNet: 4.63, vatRate: 19, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 45, featured: false },
    { name: 'Nutella Biscuits 41,4g', description: 'Mini Kekse mit Nutella, praktisch f?r unterwegs.', priceNet: 2.76, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Ritter Sport Voll-Nuss', description: 'Vollmilchschokolade mit ganzen Haseln?ssen.', priceNet: 3.27, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400&h=400&fit=crop', stock: 60, featured: true },
    { name: 'Schoko Toffees 325g', description: 'Sahrige Schoko-Toffees.', priceNet: 5.14, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 30, featured: false },
    { name: 'Smarties Hexagon 38g', description: 'Bunte Zuckerperlen mit Schokolade.', priceNet: 2.34, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Tic Tac Fresh Mint 18g', description: 'Erfrischende Minz-Dragees.', priceNet: 2.06, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 90, featured: false },
    { name: 'Toffifee 125g', description: 'Karamell mit Nougat-Creme und Haselnuss.', priceNet: 4.21, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 50, featured: false },
    { name: 'Wick Zitrone 46g', description: 'Bonbons mit Zitronengeschmack und Vitaminen.', priceNet: 3.27, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Raffaello 150g', description: 'Kokos-Mandel-Kugeln.', priceNet: 7.01, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 35, featured: true },
    { name: 'Ritter Sport Edel Vollmilch', description: 'Klassische Vollmilchschokolade.', priceNet: 3.27, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400&h=400&fit=crop', stock: 65, featured: false },
    { name: 'Ritter Sport Ganze Mandel', description: 'Vollmilchschokolade mit Mandeln.', priceNet: 3.27, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400&h=400&fit=crop', stock: 55, featured: false },
    { name: 'Ritter Sport Joghurt', description: 'Joghurtschokolade.', priceNet: 3.27, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400&h=400&fit=crop', stock: 55, featured: false },
    { name: 'Leibniz Original 200g', description: 'Klassische Butterkekse.', priceNet: 3.55, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'M&M\'s Peanut 150g', description: 'Erdn?sse in buntem Schokoladenmantel.', priceNet: 4.21, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 60, featured: true },
    { name: 'Mentos Erdbeer-Mix 37,5g', description: 'Fruchtige Kaubonbons Erdbeer-Mix.', priceNet: 2.34, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 90, featured: false },
    { name: 'Mentos Mint 38g', description: 'Erfrischende Mint Kaubonbons.', priceNet: 2.34, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 90, featured: false },
    // More Sweets & Snacks
    { name: 'Bifi 22,5g', description: 'Snack-Wurststick.', priceNet: 2.34, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Butter Toffee', description: 'Sahnige Butter-Toffees.', priceNet: 3.69, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 45, featured: false },
    { name: 'Celebrations 186g', description: 'Verschiedene Schokoladen-Sorten im Mix.', priceNet: 9.30, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400&h=400&fit=crop', stock: 25, featured: false },
    { name: 'Dextro Energy Classic 46g', description: 'Traubenzucker f?r schnelle Energie.', priceNet: 2.34, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 100, featured: false },
    { name: 'Fischerman\'s Friend Lemon', description: 'Extra starke Minzbonbons Zitrone.', priceNet: 2.62, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Fischerman\'s Friend Mint', description: 'Extra starke Minzbonbons Minze.', priceNet: 2.62, vatRate: 7, category: 'Sweets & Snacks', image: 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=400&h=400&fit=crop', stock: 70, featured: false },
    ...
    // Chips (7% VAT - food)
    { name: 'Pom-B?r Original 100g', description: 'Kartoffelsnacks in B?renform.', priceNet: 4.21, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Pringles Cheese & Onion 165g', description: 'Kartoffelchips mit K?se-Zwiebel-Geschmack.', priceNet: 4.49, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 80, featured: true },
    { name: 'Pringles Classic Paprika 165g', description: 'Kartoffelchips mit Paprika-Geschmack.', priceNet: 4.49, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 80, featured: true },
    { name: 'Lay\'s aus dem Ofen Cheese & Onion 100g', description: 'Ofen-gebackene Chips.', priceNet: 4.21, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 55, featured: false },
    { name: 'Lay\'s gesalzen 150g', description: 'Klassisch gesalzene Kartoffelchips.', priceNet: 4.67, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Pringles Sweet Paprika 165g', description: 'S??liche Paprika Chips.', priceNet: 4.49, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 65, featured: false },
    { name: 'Takis Blue Heat 92,3g', description: 'Extrem w?rzige Tortilla-Chips.', priceNet: 6.50, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 40, featured: false },
    { name: 'Pringles Original 165g', description: 'Original Kartoffelchips.', priceNet: 4.49, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Funny-Frisch Oriental 150g', description: 'W?rzige Chips mit orientalischem Geschmack.', priceNet: 4.21, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 50, featured: false },
    { name: 'Funny-Frisch Ungarisch 150g', description: 'Chips mit ungarischem W?rzgeschmack.', priceNet: 4.21, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 50, featured: false },
    { name: 'Funny-Frisch Gesalzen 150g', description: 'Klassisch gesalzene Chips.', priceNet: 4.21, vatRate: 7, category: 'Chips', image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400&h=400&fit=crop', stock: 60, featured: false },
    // Fruchtgummi & Lakritz (7% VAT)
    { name: 'Haribo Goldb?ren 175g', description: 'Klassische Goldb?ren Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 100, featured: true },
    { name: 'Haribo Happy Cola 175g', description: 'Cola-Flaschen Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 80, featured: false },
    { name: 'Haribo Phantasia 175g', description: 'Bunte Fruchtgummi-Mischung.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 75, featured: false },
    { name: 'Haribo Pfirsiche 175g', description: 'Pfirsich-Fruchtgummi mit Zucker.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Haribo Lakritz Schnecken', description: 'Lakritz-Schnecken.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Haribo Rainbow Sauer 175g', description: 'Saure Regenbogen-Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 70, featured: false },
    { name: 'Nimm2 Lachgummi Softies Frucht Mix 225g', description: 'Weiche Fruchtgummis mit Vitaminen.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Bubble Fizz 1kg', description: 'Brause-Fruchtgummi im Gro?pack.', priceNet: 23.32, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 15, featured: false },
    { name: 'Haribo Balla-Balla 175g', description: 'Schaumzucker-Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 65, featured: false },
    { name: 'Haribo Bunte T?te 175g', description: 'Bunte Fruchtgummi-Mischung.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 80, featured: true },
    { name: 'Haribo Konfekt 175g', description: 'Feine Fruchtgummi-Konfekt Mischung.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 55, featured: false },
    { name: 'Bunte T?te', description: 'Selbstgemachte S??igkeitent?te.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 100, featured: false },
    { name: 'Haribo Tropi Frutti 175g', description: 'Exotische Fruchtgummi-Mischung.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 60, featured: false },
    { name: 'Haribo Wein Gums 175g', description: 'Weinbrandbohnen-Art Fruchtgummi.', priceNet: 3.27, vatRate: 7, category: 'Fruchtgummi & Lakritz', image: 'https://images.unsplash.com/photo-1621868064663-e0dc2a1fc3f0?w=400&h=400&fit=crop', stock: 55, featured: false },
