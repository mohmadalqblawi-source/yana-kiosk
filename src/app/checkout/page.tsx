...
import { ArrowLeft, Check, CreditCard, ShoppingBag, Loader2, Truck } from 'lucide-react'
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <button
                  type="button"
                  onClick={() => setFormData({ ...formData, shippingMethod: 'dhl' })}
                  className={`relative p-4 rounded-xl border-2 text-left transition-all ${
                ...
                <button
                  type="button"
                  onClick={() => setFormData({ ...formData, shippingMethod: 'hermes' })}
                  className={`relative p-4 rounded-xl border-2 text-left transition-all ${
            ...
            >
              {submitting ? (
                ...
                <>
                  ...
                  {tr('placeOrder')} — {formatPrice(totalGross + shippingCost)}
                </>
              )}
            </motion.button>
          </form>
            ...
            <div className="space-y-3 text-sm border-t border-gray-100 pt-4">
              ...
              <div className="border-t border-gray-100 pt-3">
                <div className="flex justify-between text-lg font-bold text-gray-900">
                  <span>{tr('total')}</span>
                  <span>{formatPrice(totalGross + shippingCost)}</span>
                </div>
