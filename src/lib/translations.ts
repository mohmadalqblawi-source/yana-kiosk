export const translations = {
  ...
  product: {
    ...
    notFound: { de: 'Produkt nicht gefunden', en: 'Product not found', fa: 'محصولی یافت نشد', ar: 'المنتج غير موجود' },
  ...
  impressum: {
    title: { de: 'Impressum', en: 'Impressum', fa: 'اطلاعات حقوقی', ar: 'الإفادة القانونية' },
    subtitle: { de: 'Angaben gemäß § 5 TMG', en: 'Information according to § 5 TMG', fa: 'اطلاعات طبق § 5 TMG', ar: 'معلومات وفقاً لـ § 5 TMG' },
    operator: { de: 'Betreiber der Website', en: 'Website Operator', fa: 'گرداننده وب‌سایت', ar: 'مشغل الموقع' },
  ...
  agb: {
    ...
    sections: {
      scope: { de: '1. Geltungsbereich', en: '1. Scope', fa: '۱. دامنه کاربرد', ar: '١. نطاق التطبيق' },
      contract: { de: '2. Vertragsschluss', en: '2. Contract Conclusion', fa: '۲. انعقاد قرارداد', ar: '٢. إبرام العقد' },
      revocation: { de: '3. Widerrufsrecht', en: '3. Right of Withdrawal', fa: '۳. حق انصراف', ar: '٣. حق الإلغاء' },
      prices: { de: '4. Preise und Zahlungsbedingungen', en: '4. Prices and Payment', fa: '۴. قیمت‌ها و شرایط پرداخت', ar: '٤. الأسعار وشروط الدفع' },
      shipping: { de: '5. Liefer- und Versandbedingungen', en: '5. Delivery and Shipping', fa: '۵. شرایط تحویل و ارسال', ar: '٥. التوصيل والشحن' },
      retention: { de: '6. Eigentumsvorbehalt', en: '6. Retention of Title', fa: '۶. حق نگهداری مالکیت', ar: '٦. الاحتفاظ بالملكية' },
      warranty: { de: '7. Mängelhaftung', en: '7. Warranty', fa: '۷. ضمان عیوب', ar: '٧. ضمان العيوب' },
      liability: { de: '8. Haftung', en: '8. Liability', fa: '۸. مسئولیت', ar: '٨. المسؤولية' },
      law: { de: '9. Anwendbares Recht', en: '9. Applicable Law', fa: '۹. قانون قابل اجرا', ar: '٩. القانون الواجب التطبيق' },
